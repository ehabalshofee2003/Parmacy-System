...
Route::middleware('auth:sanctum')->group(function () {
    ...
    //الاشعارات
    Route::get('notifications/test', [NotificationController::class, 'testNotification']);
    Route::post('notifications/test', [NotificationController::class, 'testNotificationToUser']);
